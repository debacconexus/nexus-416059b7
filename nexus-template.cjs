...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Medical Robotics Safety Gateway";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Surgical Command Transaction";
process.env.TABLE_NAME = process.env.TABLE_NAME || "surgical_command_transaction_records";
'use strict';
